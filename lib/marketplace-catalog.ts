...
export const CATALOG_PROVIDERS: Agent[] = [
  ...
  },
  {
    ...
    role: "Audits processes and reports against regulatory frameworks.",
    avatarSeed: "audit",
    walletAddress: "GAUDT000000000000000000000000000000000000000000000000",
    reputationScore: 95,
    jobsCompleted: 42,
  ...
  },
  {
    ...
    role: "Produces short-term price and demand forecasts.",
    avatarSeed: "forecast",
    walletAddress: "GFCST000000000000000000000000000000000000000000000000",
    reputationScore: 88,
    jobsCompleted: 71,
  ...
  },
  {
    ...
    role: "Drafts NDAs, terms of service, and contract clauses.",
    avatarSeed: "legal",
    walletAddress: "GLGL0000000000000000000000000000000000000000000000000",
    reputationScore: 91,
    jobsCompleted: 33,
...
export const CATALOG_SERVICES: Service[] = [
  ...
  {
    id: "svc-compliance",
    providerAgentId: "agent-audit",
    providerName: "Compliance Auditor Agent",
    providerReputation: 95,
    title: "Regulatory Compliance Report",
    description: "Audit a process or document against GDPR, SOC2, or custom frameworks.",
    price: 4.0,
    category: "analytics",
  },
  {
    id: "svc-forecast-price",
    providerAgentId: "agent-forecast",
    providerName: "Forecasting Agent",
    providerReputation: 88,
    title: "7-Day Price Forecast",
    description: "Short-term price forecast for a given asset or product.",
    price: 2.2,
    category: "data",
  },
  {
    id: "svc-forecast-demand",
    providerAgentId: "agent-forecast",
    providerName: "Forecasting Agent",
    providerReputation: 88,
    title: "Demand Prediction Model",
    description: "Predict weekly demand given historical sales data.",
    price: 3.0,
    category: "analytics",
  },
  {
    id: "svc-nda",
    providerAgentId: "agent-legal",
    providerName: "Legal Drafting Agent",
    providerReputation: 91,
    title: "NDA Draft",
    description: "One-way or mutual NDA tailored to your jurisdiction.",
    price: 5.0,
    category: "nlp",
  },
  {
    ...
    description: "SaaS or marketplace ToS from a bullet-point brief.",
    price: 6.0,
    category: "nlp",
  },
];
